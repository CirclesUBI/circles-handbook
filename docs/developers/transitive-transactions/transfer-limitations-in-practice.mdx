...
We can also conclude that a steps limit of 52 can take us a long way in terms of large transfers to remote accounts, when using an efficient pathfinder.