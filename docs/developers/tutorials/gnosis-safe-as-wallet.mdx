...
<FormattedImage relativeSize="50%" src={require("!file-loader!../../../static/images/tutorials/gnosis-safe-1.png").default} alt="Screenshot show profile"/>
...
<FormattedImage relativeSize="60%" src={require("!file-loader!../../../static/images/tutorials/gnosis-safe-2.png").default} alt="Screenshot profile address"/>
...
<FormattedImage relativeSize="60%" src={require("!file-loader!../../../static/images/tutorials/gnosis-safe-3.jpeg").default} alt="Screenshot local storage"/>
...
<FormattedImage relativeSize="30%" src={require("!file-loader!../../../static/images/tutorials/gnosis-safe-4.jpeg").default} alt="Screenshot wallet"/>
