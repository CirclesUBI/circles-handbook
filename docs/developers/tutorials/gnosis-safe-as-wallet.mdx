...
<FormattedImage relativeSize="50%" src="../../../static/images/tutorials/gnosis-safe-1.png" alt="Screenshot show profile"/>
...
<FormattedImage relativeSize="60%" src="../../../static/images/tutorials/gnosis-safe-2.png" alt="Screenshot profile address"/>
...
<FormattedImage relativeSize="60%" src="../../../static/images/tutorials/gnosis-safe-3.jpeg" alt="Screenshot local storage"/>
...
<FormattedImage relativeSize="30%" src="../../../static/images/tutorials/gnosis-safe-4.jpeg" alt="Screenshot wallet"/>
