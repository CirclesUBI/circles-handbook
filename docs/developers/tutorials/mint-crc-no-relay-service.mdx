...
<FormattedImage relativeSize="50%" src="../../../static/images/tutorials/mint-crc-1.png" alt="Screenshot show profile"/>
...
<FormattedImage relativeSize="60%" src="../../../static/images/tutorials/mint-crc-2.png" alt="Screenshot show profile"/>

3. Go to [settings](https://circles.garden/settings) and note down the Token address
   
<FormattedImage relativeSize="40%" src="../../../static/images/tutorials/mint-crc-3.png" alt="Screenshot show profile"/>
...
<FormattedImage relativeSize="40%" src="../../../static/images/tutorials/mint-crc-4.jpeg" alt="Screenshot show profile"/>
