...
<FormattedImage relativeSize="50%" src="../assets/mint-crc-1.png" alt="Screenshot show profile"> </FormattedImage>
...
<FormattedImage relativeSize="60%" src="../assets/mint-crc-2.png" alt="Screenshot show profile"> </FormattedImage>

3. Go to [settings](https://circles.garden/settings) and note down the Token address
   
<FormattedImage relativeSize="40%" src="../assets/mint-crc-3.png" alt="Screenshot show profile"> </FormattedImage>
...
<FormattedImage relativeSize="40%" src="../assets/mint-crc-4.jpeg" alt="Screenshot show profile"> </FormattedImage>
