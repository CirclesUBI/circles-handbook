...
<FormattedImage relativeSize="50%" src={require("!file-loader!../../../static/images/tutorials/mint-crc-1.png").default} alt="Screenshot show profile"/>
...
<FormattedImage relativeSize="60%" src={require("!file-loader!../../../static/images/tutorials/mint-crc-2.png").default}  alt="Screenshot show profile"/>

3. Go to [settings](https://circles.garden/settings) and note down the Token address
   
<FormattedImage relativeSize="40%" src={require("!file-loader!../../../static/images/tutorials/mint-crc-3.png").default}  alt="Screenshot show profile"/>
...
<FormattedImage relativeSize="40%" src={require("!file-loader!../../../static/images/tutorials/mint-crc-4.jpeg").default}  alt="Screenshot show profile"/>
